...
void PostEffect::Initialize(SpriteCommon* spriteCommon, UINT texNumber, XMFLOAT2 anchorpoint, bool isFlipX, bool isFlipY)
{
    ...
    //デスクリプタヒープにSRV生成
    spriteCommona->GetDevice()->CreateShaderResourceView(texBuff.Get(),
        &srvDesc,
    ...
    //デスクリプタヒープにRTV作成
    spriteCommona->GetDevice()->CreateRenderTargetView(texBuff.Get(),
        nullptr,
...
void PostEffect::PreDrawScene(ID3D12GraphicsCommandList* cmdList)
{
    ...
    //シザリング矩形の設定
    cmdList->RSSetScissorRects(1, &CD3DX12_RECT(0, 0, WindowsApp::window_width,
        WindowsApp::window_height));
